defmodule PhoenixMarketDataWeb.PostLiveTest do
  use PhoenixMarketDataWeb.ConnCase

  import Phoenix.LiveViewTest
  import PhoenixMarketData.TimelineFixtures

  @create_attrs %{active: true, content: "some content", user_id: "some user_id"}
  @update_attrs %{active: false, content: "some updated content", user_id: "some updated user_id"}
  @invalid_attrs %{active: false, content: nil, user_id: nil}
